...
namespace library_app.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Published,AuthorID")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Published,AuthorID")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
